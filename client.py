...
def gameWindow(win, game, p, stage_of_action, action, nb_players=4, game_ended=False):
...
def redrawWindow(win, game, p, stage_of_action, action, nb_players=4):
    ...
    if game._ready is False:
        ...
        gameWindow(win, game, p, stage_of_action,
        ...
        gameWindow(win, game, p, stage_of_action, action,
